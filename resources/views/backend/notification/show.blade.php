<div id="notifications">
    <a class="nav-link dropdown-toggle" href="#" id="alertsDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
        ...
        <span class="badge badge-danger badge-counter">
            ...
            @if (Helper::orderCountAdmin() > 0 ) <span class="count">{{Helper::orderCountAdmin()}}</span>@endif
        </span>
      </a>
      <!-- Dropdown - Alerts -->
    ...
    <a class="dropdown-item d-flex align-items-center" target="_blank" href="{{route('admin.notification',$notification->id)}}">
        ...
        <a class="dropdown-item text-center small text-gray-500" href="{{route('order.index')}}">Show All Notifications</a>
      </div>
</div>
